...
<head>
  ...
  <title>login |<?php echo ((is_array($_tmp=$this->_tpl_vars['common']['system_name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</title>
      ...
      <table width="500"  border="0" cellspacing="0" cellpadding="3">
        <tr>
          ...
          <td width="70%" align="left">
            <input id="f_login_id" name="f_login_id" type="text" class="formst" value="<?php echo $this->_tpl_vars['param']['f_login_id']; ?>
" />
          </td>
        </tr>
      </table>
