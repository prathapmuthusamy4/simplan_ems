...
class newProcess extends addEmployeeCommon
{
    /**
     * 初期設定
     *
    ...
    function initProc()
    {
        ...
        $this->session_name = ADMIN_ADD_EMPLOYEE_NEW_SESSION;
    ...
    function executeRegist($input)
    {
        ...
        // start
        $this->begin();
        if (!$this->regist($this->param) || !$this->registId($this->param)) {
            // rollback
            $this->rollback();
