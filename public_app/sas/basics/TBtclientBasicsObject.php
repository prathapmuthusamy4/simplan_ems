...
class   TBtclientBasicsObject
{
     ...
     * @return  none
    **/
    function TBtclientBasicsObject() {
        $this->table_name   = 't_btclient';
        $this->table_comment= 'クライアントマスタ';
        ...
        $this->field_type   = array(
                   ...
                   'f_name' => 'varchar',
                   'f_device' => 'varchar',
                   'f_device_size' => 'varchar',
                   'f_device_color' => 'varchar',
                   'f_device_price' => 'varchar',
                   'f_del_flg' => 'char',
                   'f_reg_account' => 'int',
                   'f_reg_time' => 'datetime',
                   'f_upd_account' => 'int',
