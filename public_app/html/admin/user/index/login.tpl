...
<!--header-->
  <div id="header" style="margin-top:10px;">
    <img src="img/logo.jpg" alt="{$common.system_name|escape}～{$common.name|escape}～" width="250" />
  </div>
  <div id="cc"></div>
  <!--maindefault-->
  <div id="mainstaget">
    ...
    <div id="logs">
      <table width="500"  border="0" cellspacing="0" cellpadding="3">
        <tr>
          <td width="30%" align="center" bgcolor="#B63737"><p>ログインID<img src="img/ar.gif" width="12" height="12" align="absmiddle" /></p></td>
      ...
      <table width="500"  border="0" cellspacing="0" cellpadding="3">
        <tr>
          <td width="30%" align="center" bgcolor="#B63737"><p>パスワード<img src="img/ar.gif" width="12" height="12" align="absmiddle" /></p></td>
          <td width="70%" align="left">
      ...
      <table width="500"  border="0" cellspacing="0" cellpadding="3">
        <tr>
          <td width="100%" align="center">
            <a href="javascript:void(0);" onclick="return submitfrm('index.php', 'index', 'login');" >
              <img src="img/login.gif" alt="ログイン" title="ログイン" width="140" height="30" />
            </a>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td width="100%" align="center">
            <div id="remind">
            <a href="javascript:void(0);" onclick="return submitfrm('index.php', 'index', 'remind');" title="パスワードを忘れましたか？">
