...
<div id="topwrap">
  ...
  <div id="mainstaget">
    ...
    <div id="logs">
  {* <p>パスワードを再発行します。新しいパスワードを入力して下さい。</p><br />
      ...
      <table width="500"  border="0" cellspacing="0" cellpadding="3">
        <tr>
          <td width="30%" align="center" bgcolor="#B63737"><p>パスワードの送信<img src="img/ar.gif" width="12" height="12" align="absmiddle" /></p></td>
          <td width="70%" align="left">
            <input class="formstb_350" placeholder="メールアドレス" name="f_mailaddress" type="f_mailaddress" value="{$param.f_mailaddress|escape}" autofocus>
          ...
          <td width="100%" align="center">
            <div id="rpt">
             <a href="javascript:void(0);" onclick="return submitfrm('index.php', 'index', 'remind_comp');">
              <img src="img/reissue.gif" alt="送信" title="送信" width="140" height="30" />
            </a>
            </div>
          </td>
        </tr>
