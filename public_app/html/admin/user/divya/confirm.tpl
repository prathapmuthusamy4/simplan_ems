...
<table width="980"  border="0" cellpadding="0" cellspacing="1" bgcolor="#cccccc">
    <tr valign="top" bgcolor="#FFFFFF">
      <td width="20%" valign="middle" class="tdcls1"><span class="cap1">Reg.No</span></td>
      <td width="80%" valign="middle" class="tdcls2">
          {$param.f_reg_no|escape}
      </td>
    </tr>
    <tr valign="top" bgcolor="#FFFFFF">
    ...
    {if $param.f_graduate == $smarty.const.STATUS_DISP_GRADUATE_YES}
    <tr valign="top" bgcolor="#FFFFFF">
        <td width="20%" valign="middle" class="tdcls1"><span class="cap1">Mark</span></td>
        <td width="80%" valign="middle" class="tdcls2">
            {$param.f_mark|escape}&nbsp;CGPA
        </td>
    </tr>
    ...
    <tr valign="top" bgcolor="#FFFFFF">
        <td width="20%" valign="middle" class="tdcls1"><span class="cap1">Sample</span></td>
        <td width="80%" valign="middle" class="tdcls2">
            {array_value key=$param.f_priya_id list=$param.disp_sample|escape}&nbsp;
        </td>
    </tr>
    <tr valign="top" bgcolor="#FFFFFF">
