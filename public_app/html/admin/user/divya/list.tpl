        ...
        <li>
            ...
            <table width="980"  border="0" cellpadding="0" cellspacing="1" bgcolor="#cccccc">
                <tr valign="top" bgcolor="#FFFFFF" height="25">
                    <td width="20%" valign="middle"><h4>Reg.No</h4></td>
                    <td width="80%" valign="middle" bgcolor="#F5F5F5">
                        <input name="f_reg_no" type="text" class="formstb" value="{$param.f_reg_no}" />
            ...
            <div id="pt">
                <input type="button" class="formbtn" onClick="return submitfrm('divya.php', 'list', 'search');" value="Search"/>
            </div>
            <table width="980"  border="0" cellpadding="0" cellspacing="1" bgcolor="#cccccc">
             <tr valign="top" bgcolor="#FFFFFF" height="25">
              <td width="20%" valign="middle"><h4>CSVUpload</h4></td>
               <td width="80%" valign="middle" bgcolor="#F5F5F5">
                 ...
                 &nbsp;&nbsp;<input type="button" class="formbtn" onClick="return submitfrm('divya.php', 'list', 'csv_upload');" value="CSVUpload"/>
        ...
        <li>
            ...
            <table width="980"  border="0" cellpadding="0" cellspacing="1" bgcolor="#cccccc">
                <tr align="center" valign="top" bgcolor="#F5F5F5" height="30">
                    ...
                    <td width="10%" valign="middle" class="tfextra">Reg.No</td>
                    ...
                    <td width="10%" valign="middle" class="tfextra">Graduate</td>
                ...
                {foreach from=$param.list item="cur" name="current"}
                    <tr valign="top" bgcolor="{cycle values="#FFFFFF,#FAFAD2"}" height="30">
                        ...
                        <td align="left"   valign="middle" class="tfextrb">{$cur.f_reg_no|escape}</td>
                        ...
                        <td align="center" valign="middle" class="tfextrb"> 
                            <input type="button" class="formstc" onClick="return selectfrm('divya.php', 'edit', '', '{$cur.f_divya_id|escape}');" value="Edit" />
                            <input type="button" class="formstc" onClick="return selectfrm('divya.php', 'del',  'confirm', '{$cur.f_divya_id|escape}');" value="Del"/>
                            <input type="button" class="formstc" onClick="return selectfrm('divya.php', 'detail',  'confirm', '{$cur.f_divya_id|escape}');" value="Detail" /></a>
                        </td>
                    </tr>
                {foreachelse}
            ...
            <div id="pt">
                <input type="button" class="formbtn" onClick="return submitfrm('divya.php', 'new', '');" value="New Register"/>
                <input type="button" class="formbtn" onClick="return submitfrmNofalse('divya.php', 'list', 'csvdownload');" value="CSVDownload" />
            </div>
        </li>
    </ul>
    <div id="pt">
