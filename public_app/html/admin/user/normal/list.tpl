...
<div id="rightm">
    ...
    <ul id="main">
        <li>
            ...
            <div id="pt">
                <input type="button" class="formbtn" onClick="return submitfrm('normal.php', 'list', 'search');" value="Search"/>
            </div>
        </li>
        <li>
            ...
            <table width="980"  border="0" cellpadding="0" cellspacing="1" bgcolor="#cccccc">
                <tr align="center" valign="top" bgcolor="#F5F5F5" height="30">
                    ...
                    <td width="20%" valign="middle" class="tfextra">Gender</td>
                ...
                {foreach from=$param.list item="cur" name="current"}
                    <tr valign="top" bgcolor="{cycle values="#FFFFFF,#FAFAD2"}" height="30">
                        ...
                        <td align="center" valign="middle" class="tfextrb">
                            <input type="button" class="formstc" onClick="return selectfrm('normal.php', 'edit', '', '{$cur.f_normal_id|escape}');" value="Edit" />
                            <input type="button" class="formstc" onClick="return selectfrm('normal.php', 'del',  'confirm', '{$cur.f_normal_id|escape}');" value="Del"/>
                            <a id="fancybox" href="fancy.php?prc=normal_detail&sid={$cur.f_normal_id|escape}" style="text-decoration:none;"><input type="button" class="formstc" value="detail" /></a>
                        </td>
                    </tr>
                {foreachelse}
            ...
            <div id="pt">
                <input type="button" class="formbtn" onClick="return submitfrm('normal.php', 'zip', 'zip');" value="Zip" />
                <input type="button" class="formbtn" onClick="return submitfrm('normal.php', 'new', '');" value="New Register" />
            </div>
        </li>
    </ul>
    <div id="pt">
