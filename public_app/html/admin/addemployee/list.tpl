    ...
    <li>
      ...
      <table width="980"  border="0" cellpadding="0" cellspacing="1" bgcolor="#cccccc">
        ...
        <tr valign="top" bgcolor="#FFFFFF" height="25">
          ...
          <td width="80%" valign="middle" bgcolor="#F5F5F5">
            {html_checkboxes name='f_language' options=$param.disp_language selected=$param.f_language separator='&nbsp;'}
    ...
    <li>
      ...
      <table width="980"  border="0" cellpadding="0" cellspacing="1" bgcolor="#cccccc">
        ...
        <tr valign="top" bgcolor="{cycle values="#FFFFFF,#FAFAD2"}" height="30">
          ...
          <td align="center" valign="middle" class="tfextrb">
            <input type="button" class="formstc" onClick="return selectfrm('addemployee.php', 'edit', '', '{$cur.f_employee_id|escape}');" value="Edit" />
            <input type="button" class="formstc" onClick="return selectfrm('addemployee.php', 'detail',  'confirm', '{$cur.f_employee_id|escape}');" value="Detail" />
