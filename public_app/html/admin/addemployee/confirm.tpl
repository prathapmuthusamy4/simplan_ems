...
<table width="980"  border="0" cellpadding="0" cellspacing="1" bgcolor="#cccccc">
    ...
    <tr valign="top" bgcolor="#FFFFFF">
      ...
      <td width="80%" valign="middle" class="tdcls2">
            {array_value key=$param.f_emp_status list=$param.disp_emp_status|escape}&nbsp;
      </td>
    </tr>
    ...
    <tr valign="top" bgcolor="#FFFFFF">
      ...
      <td width="80%" valign="middle" class="tdcls2">
          <span>{$param.f_experience|escape}</span>&nbsp;years
      </td>
    </tr>
    <tr valign="top" bgcolor="#FFFFFF">
      <td width="20%" valign="middle" class="tdcls1"><span class="cap1">Graduate->UG</span></td>
      <td width="80%" valign="middle" class="tdcls2">
           {array_value key=$param.f_education_ug list=$param.disp_education_ug|escape}&nbsp;
      </td>
    </tr>
    {if $param.f_education_ug == $smarty.const.ALLOW_EDUCATION_UG_YES}
    <tr valign="top" bgcolor="#FFFFFF">
      <td width="20%" valign="middle" class="tdcls1"><span class="cap1">Degree->UG</span></td>
      <td width="80%" valign="middle" class="tdcls2">
          {$param.f_degree_ug|escape}
      </td>
    </tr>
    {/if}
    {if $param.f_education_ug == $smarty.const.ALLOW_EDUCATION_UG_YES}
    ...
    {/if}
      ...
      <td width="80%" valign="middle" class="tdcls2">
           {array_value key=$param.f_education_pg list=$param.disp_education_pg|escape}&nbsp;
      </td>
    </tr>
    {if $param.f_education_pg == $smarty.const.ALLOW_EDUCATION_PG_YES}
    <tr valign="top" bgcolor="#FFFFFF">
      <td width="20%" valign="middle" class="tdcls1"><span class="cap1">Degree->PG</span></td>
      <td width="80%" valign="middle" class="tdcls2">
          {$param.f_degree_pg|escape}
      </td>
    </tr>
    {/if}
    {if $param.f_education_pg == $smarty.const.ALLOW_EDUCATION_PG_YES}
    ...
    <tr valign="top" bgcolor="#FFFFFF">
      ...
      <td width="80%" valign="middle" class="tdcls2">
          {$param.f_additional_skill|escape}
      </td>
    </tr>
    <tr valign="top" bgcolor="#FFFFFF">
      <td width="20%" valign="middle" class="tdcls1"><span class="cap1">Language</span></td>
      <td width="80%" valign="middle" class="tdcls2">
            {foreach from=$param.f_language item="cur" name="current"}
                {array_value key=$cur list=$param.disp_language|escape}
            {/foreach}
            {if array_key_exists(ALLOW_LANGUAGE_OTHERS, $param.disp_language)}
    ...
    <tr valign="top" bgcolor="#FFFFFF">
      ...
      <td width="80%" valign="middle" class="tdcls2">
          {array_value key=$param.f_jlpt list=$param.disp_jlpt|escape}&nbsp;
      </td>
    </tr>
</table>
