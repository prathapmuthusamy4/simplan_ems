...
<head>
  <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <title>Reissue Password |{$common.system_name|escape}</title>
...
<div id="topwrap">
  ...
  <div id="mainstaget">
    <h3>SIMPLAN</h3>
    <div id="logs">
      <p align="center">A password notification email has been sent to the email address you entered. <br>Please reset the password in the email.</p><br /><br /><br />
      <table width="500"  border="0" cellspacing="0" cellpadding="3">
        <tr>
          <td width="100%" align="center">
            <a href="javascript:void(0);" onclick="return submitfrm('index.php', '', '');" >
              <img src="img/go_login.gif" alt="Go to login screen" title="Go to login screen" width="140" height="30" />
            </a>
          </td>
        </tr>
      </table>
